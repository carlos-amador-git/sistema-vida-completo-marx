...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-vida-700 shadow-sm',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-red-700 shadow-sm',
        success: 'bg-salud-600 text-white hover:bg-salud-700 shadow-sm',
        outline: 'border-2 border-primary text-primary hover:bg-vida-50 dark:hover:bg-vida-950',
