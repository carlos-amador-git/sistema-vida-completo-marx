        ...
        <>
          ...
          <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
            >
              {copied ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-3">
            {typeof navigator.share === 'function' && (
              ...
              >
                <div className="p-2 bg-vida-100 dark:bg-vida-900/30 rounded-lg">
            ...
            <button
              ...
              className={`flex items-center gap-3 p-3 border rounded-lg transition-colors ${
                showQR ? 'border-vida-300 bg-vida-50 dark:border-vida-700 dark:bg-vida-900/30' : 'border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50'
              }`}
            >
              <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <QrCode className="w-5 h-5 text-gray-600 dark:text-gray-400" aria-hidden="true" />
              </div>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
          ...
          {/* QR Code Display */}
          {showQR && emergencyUrl && (
            <div className="flex flex-col items-center p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
              <QRCodeSVG
                value={emergencyUrl}
                size={200}
                level="M"
  ...
  if (isMobile) {
    return (
      <BottomSheet
        ...
        title={t('share.title', { defaultValue: 'Compartir Perfil Medico' })}
      >
        {shareContent}
      </BottomSheet>
    );
